    ...
    <section class="article">
        <div class="row">
            <div class="article-col">
                ...
                <h1>DEFEU EN FIBRE DE CARBONE<br><p>€34.00 
                ...
                ADHeRENCE EXTReME
                <br>
                Les maniques CrossFit®DEFEU WODANDGO offrent la meilleure adhérence. Spécialement conçues pour les Training et les WODS, les grips WODANDGO épousent la forme de vos mains pour des performances extrêmes.
                <br></p><br>
...
<?php 
    if (isset($_POST['add'])){
        ...
        $upd = "UPDATE `panier` SET `Glove2`='1' WHERE `Identifiant`='$fn' and `Pass`='$ln'";
