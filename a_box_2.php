    ...
    <section class="article">
        <div class="row">
            <div class="article-col">
                ...
                <h1>ROGUE ECHO FOAM GAMES BOX<br><p>€336.00 
                ...
                ECHO FOAM GAMES BOX
                <br>
                Pesant 41 lb, ces cubes Echo ne pèsent pas autant que les cubes Rogue Foam Games Box standard (58 lb), mais ils sont très mobiles et relativement faciles à manœuvrer et à empiler.
                <br></p><br>
...
<?php 
    if (isset($_POST['add'])){
        ...
        $upd = "UPDATE `panier` SET `Box2`='1' WHERE `Identifiant`='$fn' and `Pass`='$ln'";
