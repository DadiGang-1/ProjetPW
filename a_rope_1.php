    ...
    <section class="article">
        <div class="row">
            <div class="article-col">
                ...
                <h1>FRONING SR-1F SPEED ROPE 2.0<br><p>€80.00 
                ...
                FRONING SR-1F
                <br>
                Le modèle 2.0 exclusif de notre corde Froning SR-1F Speed Rope comporte de nouvelles têtes en aluminium, des roulements haute vitesse, des poignées plus ferme et légères, dotées d’un grip texturé et allongé en forme de diamant. Combinée à un câble en polyuréthane de 0.09" d’épaisseur et aux choix personnels de Rich Froning
                <br></p><br>
...
<?php 
    if (isset($_POST['add'])){
        ...
        $upd = "UPDATE `panier` SET `Rope1`='1' WHERE `Identifiant`='$fn' and `Pass`='$ln'";
