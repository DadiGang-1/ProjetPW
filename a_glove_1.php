    ...
    <section class="article">
        <div class="row">
            <div class="article-col">
                ...
                <h1>BEAR KOMPLEX CARBON NO HOLE SPEED GRIPS<br><p>€55.00 
                ...
                BEAR KOMPLEX
                <br>
                Conçu pour protéger la paume de vos mains à tout instant et assurer la stabilité de votre poignet sans restreindre sa mobilité, les protections Speed Grips No Hole Carbone Bear KompleX adhèrent à toutes les barres, qu’elles soient lisses ou revêtues de poudre et que vous utilisiez ou non de la craie.
                <br></p><br>
...
<?php 
    if (isset($_POST['add'])){
        ...
        $upd = "UPDATE `panier` SET `Glove1`='1' WHERE `Identifiant`='$fn' and `Pass`='$ln'";
