    ...
    <section class="article">
        <div class="row">
            <div class="article-col">
                ...
                <h1>BOX JUMP, BOX DE PLIOMETRIE, PLYOBOX<br><p>€80.00 
                ...
                <!----ICI TEXTE ARTICLE---->
                Le Pivot Fitness Plyobox
                <br>
                1 plyobox avec 3 hauteurs différentes 20", 24" et 30" pouces (51x61x76 cm) Contreplaques forts d'haute qualité Livré comme boîte de construction, facile à monter Poignées pour une transport facile
                <br></p><br>
...
<?php 
    if (isset($_POST['add'])){
        ...
        $upd = "UPDATE `panier` SET `Box3`='1' WHERE `Identifiant`='$fn' and `Pass`='$ln'";
