...
<body>
    ...
    <section class="article">
        <div class="row">
            <div class="article-col">
                ...
                <h1>ROGUE FLAT PACK GAMES BOX<br><p>€165.00 
                ...
                3-IN-1 PLYO BOX
                <br>
                Get a 20", 24" and 30" tall plyo box all in one. The Rogue Flat Pack Games Box has a similar beefy design with an internal reinforcing component just like our standard games box. This one ships unassembled to keep costs as low as possible and save you money on shipping! 
                <br></p><br>

                <!--<a href="indisponible.php" class="hero-btn">Ajouter au panier</a>-->
    ...
    if (isset($_POST['add'])){
        ...
        $upd = "UPDATE `panier` SET `Box1`='1' WHERE `Identifiant`='$fn' and `Pass`='$ln'";
