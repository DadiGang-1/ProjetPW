    ...
    <section class="article">
        <div class="row">
            <div class="article-col">
                ...
                <h1>Velites Corde à sauter Fire 2.0<br><p>€42.00 
                ...
                Fire 2.0
                <br>
                CORDE À SAUTER DE VITESSE : La corde à sauter pour adultes la plus avancée avec embouts inférieurs bas vissables. La clé de réglage est conçue pour s’insérer dans la base, vous ne la perdrez donc jamais. 
                <br></p><br>
...
<?php 
    if (isset($_POST['add'])){
        ...
        $upd = "UPDATE `panier` SET `Rope3`='1' WHERE `Identifiant`='$fn' and `Pass`='$ln'";
